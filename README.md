# Eric Prates — Desenvolvedor Full Stack

Desenvolvedor Full Stack cursando ADS, com experiência prática em projetos 
web e mobile com TypeScript/JavaScript e Java. Foco em construir produtos 
completos, do frontend às APIs e integrações.
...
`React` `Next.js` `TypeScript` `Node.js` `Express` `SQLite` `JWT`
...
filtros de busca com persistência em local storage.
`React Native` `JavaScript`

### [ZeV — Gerenciador de Eventos](https://github.com/EricPrates/ZezinEventos)
...
**Frontend:** TypeScript · JavaScript · React · Next.js · React Native · HTML · CSS  
**Backend:** Node.js · Express · Java  
**Banco de dados:** SQLite · MySQL · Supabase  
**Outros:** JWT · AWS EC2 · PM2 · Git
